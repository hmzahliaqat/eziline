...
<!--[if BLOCK]><![endif]--><?php if(auth()->user()->role==2): ?>
        ...
        <?php elseif(auth()->user()->role==1): ?>
                <span class="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Manager</span>

                <?php else: ?>
                <span class="inline-flex items-center rounded-md bg-purple-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">User</span>
...
<?php /**PATH C:\xampp\htdocs\ezi\resources\views/navigation-menu.blade.php ENDPATH**/ ?>